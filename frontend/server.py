...
TEST_PROJECTS: dict[str, dict[str, str]] = {
    ...
    "579_Z1640": {
        "project": "579_Z1640",
        "project_label": "579 Z1640",
        "execution_target": "hardware",
        "execution_target_label": "579 真机",
        "case_map_dir": "579_case_map",
        "case_map_profile": "579_Z1640",
        "execution_adapter": "watch_579_ble",
        "preflight_adapter": "watch_579_ble",
        "transport": "pc_ble_legacy_l1_l2",
        "capture_provider": "unavailable",
    },
}
    ...
    def _run_batch_body(self, job_id: str) -> None:
        ...
        for offset, case in enumerate(cases[completed:], start=completed):
            ...
            execution = self._execute_case(
                ...
                job_dir=case_dir,
                hardware_preflight_completed=hardware_preflight_completed,
                hardware_preparation_completed=(
                    execution_target == "hardware"
                    and project_meta.get("execution_adapter") != "watch_579_ble"
                ),
            )
